...
Following are some steps you can follow to step through the demo.
	...
	gdb ./example_now
		...
		# we should see something like "0x0000555555555030 ? jmp    QWORD PTR [rip+0x2f92]        # 0x555555557fc8 <puts@got.plt>"
		...
		# gdb will output and be able to tell us that, yes, this address is the addres in the got for puts, and if we follow the value contained
