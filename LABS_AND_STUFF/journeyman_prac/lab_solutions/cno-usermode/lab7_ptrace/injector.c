...
int main(int argc, char* argv[]) {
	...
	// Save program state
	// Cause the target to run mmap to allocate area for a stack and dlopen arguments
	// Copy over the dlopen arguments
	// Cause the target to run dlopen (make sure the stack is aligned before the call)
	// Restore program state
	
	/*
	 *	Student's need to fill in here
	 */
