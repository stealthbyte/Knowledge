...
Objectives:
	...
	Cause ssh to always connect to evil.com regardless of input parameters.
...
Tips:
	You can referance elf.h at "/usr/include/elf.h" for the elf header format.
	...
	ssh -o StrictHostKeyChecking=no -o LogLevel=ERROR user@host.com
		...
		Also add -o UserKenownHostsFile=/dev/null to not add to the known hosts
